...
const { formatMessages, generateLocationMessage } = require('./public/use/message.js');
// const generateLocationMessage = require('./public/use/message.js');
...
io.on('connection', (socket) => {
    socket.on('joinRoom', ({ username, room }) => {
        ...
        socket.emit('message', formatMessages(botname, 'Welcome to whatapp chat app!'))
